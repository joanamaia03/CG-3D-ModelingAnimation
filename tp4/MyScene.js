...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.frontTexture = new CGFtexture(this, 'images/mineSide.png');
        this.rightTexture = new CGFtexture(this, 'images/mineSide.png');
        this.backTexture = new CGFtexture(this, 'images/mineSide.png');
        this.leftTexture = new CGFtexture(this, 'images/mineSide.png');
        ...
        this.cube = new MyUnitCubeQuad(this, this.topTexture, this.frontTexture, this.rightTexture, this.backTexture, this.leftTexture, this.bottomTexture);
