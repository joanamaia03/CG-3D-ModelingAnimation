...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.cylinder = new MyCylinder(this,3,20);
        
        this.objects = [this.cylinder, this.prism,  this.pyramid, this.cone, this.unitCube, this.tangram, this.plane];

        // Labels and ID's for object selection on MyInterface
        this.objectIDs = {'Cylinder': 0, 'Prism': 1 , 'Pyramid': 2, 'Cone': 3, 'Cube': 4, 'Tangram': 5, 'Plane': 6};
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(160/255, 84/255, 40/255, 1.0);
